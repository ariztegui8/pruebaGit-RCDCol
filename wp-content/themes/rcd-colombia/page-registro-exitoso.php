...
<div class="fondo-des">
    <div class="fondo-mob">
        <div class="container">
            <h2 class="subti">¡Tu solicitud de suscripción fue enviada con éxito! </h2>

            <p style="text-align: center;">Pronto te enviaremos contenido exclusivo de las últimas tendencias</p>

            <div class="btn-pink">
                <a href="<?php echo get_option('home'); ?>">Volver al Home</a>
            </div>

            <img class="img-m" src="<?php bloginfo( 'template_url' ); ?>/assets/vector22.png" alt="Rompecabeza">
